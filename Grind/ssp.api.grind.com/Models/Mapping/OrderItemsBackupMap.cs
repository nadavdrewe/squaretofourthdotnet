...
{
    public class OrderItemsBackupMap : EntityTypeConfiguration<OrderItemsBackup>
    {
        public OrderItemsBackupMap()
        {
            // Primary Key
            this.HasKey(t => new { t.orderitem_id, t.catering_complete, t.cost, t.course_number, t.crv_value, t.cup_qty, t.cup_weight, t.deleted, t.dining_option, t.discount_amount, t.discount_rule_amount, t.discount_taxed, t.initial_price, t.is_cold, t.is_coupon, t.is_gift, t.modifier_amount, t.modifier_cost, t.on_hold, t.price, t.printed, t.quantity, t.shared, t.split_parts, t.split_type, t.split_with_seat, t.tax_amount, t.tax_rate, t.tax_rebate, t.taxed_flag, t.temp_sort, t.weight, t.total_price_after_tax, t.total_price_after_discount, t.parent_order_id, t.product_id, t.pure_sales });

            // Properties
            this.Property(t => t.orderitem_id)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.cost)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.course_number)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.crv_value)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.cup_qty)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.cup_weight)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.discount_rule_amount)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.discount_taxed)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.initial_price)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.modifier_amount)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.modifier_cost)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.shared)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.split_parts)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.split_type)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.split_with_seat)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.tax_amount)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.tax_rate)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.tax_rebate)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.temp_sort)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.weight)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.total_price_after_tax)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.total_price_after_discount)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.parent_order_id)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.product_id)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.pure_sales)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            // Table & Column Mappings
            this.ToTable("OrderItemsBackup");
            ...
            this.Property(t => t.Order_order_id).HasColumnName("Order_order_id");
        }
    }
}
