...
namespace WebReboot.Grind._808nd.com.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            var usersAndRoles = db.AspNetUsers.Include(x => x.AspNetRoles).ToList();
        ...
        {
            var user = db.AspNetUsers.Include(x => x.AspNetRoles).Where(x => x.Id == model.Id).FirstOrDefault();
            var newRole = db.AspNetRoles.Where(x => x.Id == model.Role.Id).First();
