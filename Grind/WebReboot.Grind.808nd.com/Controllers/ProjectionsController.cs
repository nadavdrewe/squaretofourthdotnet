...
namespace WebReboot.Grind._808nd.com.Controllers
{
    public class ProjectionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProjectionFigure")] Projection projection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProjectionFigure")] Projection projection)
        {
            if (ModelState.IsValid)
            {
